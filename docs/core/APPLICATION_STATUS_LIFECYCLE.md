...
- ASSESSMENT_TAKEN -> PASSED, NOT_QUALIFIED, ASSESSMENT_TAKEN, ASSESSMENT_SCHEDULED, WITHDRAWN
...
- Recording score via step-result endpoints is not a final pass/fail decision.
- Registrar explicitly triggers PASSED or NOT_QUALIFIED transition after score review.
