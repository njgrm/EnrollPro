...
function resolvePageTitle(pathname: string): string | null {
	...
	const exact: Record<string, string> = {
		...
		'/apply': 'BASIC EDUCATION EARLY REGISTRATION FORM',
		'/f2f-early-registration': 'Walk-in BASIC EDUCATION EARLY REGISTRATION FORM',
		...
		'/early-registration': 'BASIC EDUCATION EARLY REGISTRATION FORM — Monitoring',
		'/early-registration/pipelines': 'Registration Pipelines',
